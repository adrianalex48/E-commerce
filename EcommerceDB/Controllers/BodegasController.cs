...
namespace EcommerceDB.Controllers
{
    public class BodegasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ubicacion,Capacidad")] Bodega bodega)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ubicacion,Capacidad")] Bodega bodega)
        {
            if (id != bodega.Id)
            {
                return NotFound();
